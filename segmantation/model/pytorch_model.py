...
class PytorchModel(pl.LightningModule):
    def __init__(self, architecture, encoder_name, in_channels, out_classes,  image_path, mask_path, 
                 train_ratio,  num_workers, batch_size, img_size, max_epoch):
        super().__init__()
    ...
    def shared_step(self, batch, stage): 
        ...
        image, mask = batch
       # print(image.shape, mask.shape, stage)
    ...
    def configure_optimizers(self):
        ...
        scheduler = lr_scheduler.CosineAnnealingLR(optimizer, T_max=self.max_epoch, eta_min=1e-5)
        return {
            "optimizer": optimizer,
            "lr_scheduler": {
                "scheduler": scheduler,
